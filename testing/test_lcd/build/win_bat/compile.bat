...
avr-gcc -g -Os -mmcu=%mmcu% -c %src_dir%/../testing/test_lcd/src/main.cpp -o %output_dir%/main.o


@echo --------------------------Linking--------------------------

avr-gcc -g -mmcu=%mmcu% -Wl,-Map,%output_dir%/main.map -o %output_dir%/main.elf %output_dir%/TFT_ST7735.o %output_dir%/Graphic.o %output_dir%/main.o
