...
avr-gcc -g -Os -mmcu=%mmcu% -c %src_dir%/Tasks.cpp -o %output_dir%/Tasks.o
avr-gcc -g -Os -mmcu=%mmcu% -c %src_dir%/../testing/demo/src/main.cpp -o %output_dir%/main.o


@echo --------------------------Linking--------------------------

avr-gcc -g -mmcu=%mmcu% -Wl,-Map,%output_dir%/main.map -o %output_dir%/main.elf %output_dir%/Crc.o %output_dir%/TFT_ST7735.o %output_dir%/Graphic.o %output_dir%/UI_Engine.o %output_dir%/Tasks.o %output_dir%/Demo.o %output_dir%/main.o
